...
<body ng-controller="DemoController" id="list">
<script>
    var teckaaNgApp = angular.module('teckaaNgApp', []);

    teckaaNgApp.config(function($interpolateProvider) {
        $interpolateProvider.startSymbol('[ng[');
        $interpolateProvider.endSymbol(']ng]');
    });


    teckaaNgApp.controller('DemoController', function($scope) {
